...
class TestFormulaParser:
    ...
    def test_create_congruence_graph():
        ...
        assert congruence_graph == {'1': {'find': '1', 'index': 2, 'parents': {('f', '1', '2'): ('f', '1', '2')}},
                                    '2': {'find': '2', 'index': 3, 'parents': {('f', '1', '2'): ('f', '1', '2')}},
                                    'a': {'find': 'a', 'index': 1, 'parents': {}},
                                    ('f', '1', '2'): {'find': ('f', '1', '2'), 'index': 4, 'parents': {}}}

        formula = '(declare-fun f (Int Int) Bool) (assert (= 1 (and f(5,7) f(f(1,2), 2)))'
        cnf_formula, _, (_, congruence_graph) = FormulaParser.import_uf(formula)
        assert congruence_graph == {'1': {'find': '1', 'index': 1, 'parents': {('f', '1', '2'): ('f', '1', '2')}},
                                    '2': {'find': '2',
                                          'index': 5,
                                          'parents': {('f', '1', '2'): ('f', '1', '2'),
                                                      ('f', ('f', '1', '2'), '2'): ('f', ('f', '1', '2'), '2')}},
                                    '5': {'find': '5', 'index': 2, 'parents': {('f', '5', '7'): ('f', '5', '7')}},
                                    '7': {'find': '7', 'index': 3, 'parents': {('f', '5', '7'): ('f', '5', '7')}},
                                    ('f', '1', '2'): {'find': ('f', '1', '2'),
                                                      'index': 6,
                                                      'parents': {('f', ('f', '1', '2'), '2'): ('f',
                                                                                                ('f', '1', '2'),
                                                                                                '2')}},
                                    ('f', '5', '7'): {'find': ('f', '5', '7'), 'index': 4, 'parents': {}},
